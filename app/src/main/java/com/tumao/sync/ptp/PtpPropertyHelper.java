...
public class PtpPropertyHelper {
    ...
    public static String mapToString(int productId, int property, int value) {
        switch (property) {
            ...
            case PtpConstants.Property.EosDriveMode:
                return eosDriveModeMap.get(value);
            case PtpConstants.Property.WhiteBalance:
                return nikonWhitebalanceMap.get(value);
            case PtpConstants.Property.FNumber: {
                int major = value / 100;
                int minor = value % 100;
                if (minor == 0) {
                    return "f " + major;
            ...
            case PtpConstants.Property.ExposureTime: {
                if (value == 0xFFFFFFFF) {
                    return "Bulb";
                }
            ...
            case PtpConstants.Property.ExposureIndex:
            ...
            case PtpConstants.Property.NikonActivePicCtrlItem:
                return nikonActivePicCtrlItemMap.get(value);
            case PtpConstants.Property.FocusMeteringMode:
                return nikonFocusMeteringModeMap.get(value);
            case PtpConstants.Property.NikonExposureIndicateStatus:
            ...
            case PtpConstants.Property.ExposureBiasCompensation: {
    ...
    public static Integer mapToDrawable(int property, int value) {
        switch (property) {
            case PtpConstants.Property.EosWhitebalance: {
                ...
                return resId != null ? resId : R.mipmap.whitebalance_unknown;
            }
            case PtpConstants.Property.EosShootingMode: {
                Integer resId = eosShootingModeIconsMap.get(value);
                return resId != null ? resId : R.mipmap.shootingmode_unknown;
            }
            case PtpConstants.Property.EosMeteringMode: {
                Integer resId = eosMeteringModeIconsMap.get(value);
                return resId != null ? resId : R.mipmap.whitebalance_unknown; //TODO own unknown image
            }
            case PtpConstants.Property.EosDriveMode: {
            ...
            case PtpConstants.Property.ExposureProgramMode: {
                Integer resId = nikonExposureProgramMap.get(value);
                return resId != null ? resId : R.mipmap.whitebalance_unknown;
            }
            case PtpConstants.Property.ExposureMeteringMode: {
    ...
    static {
        ...
        eosWhitebalanceIconsMap.put(0, R.mipmap.whitebalance_auto);
        eosWhitebalanceIconsMap.put(1, R.mipmap.whitebalance_daylight);
        eosWhitebalanceIconsMap.put(2, R.mipmap.whitebalance_cloudy);
        eosWhitebalanceIconsMap.put(3, R.mipmap.whitebalance_tungsten);
        eosWhitebalanceIconsMap.put(4, R.mipmap.whitebalance_fluorescent);
        eosWhitebalanceIconsMap.put(5, R.mipmap.whitebalance_flash);
        eosWhitebalanceIconsMap.put(6, R.mipmap.whitebalance_manual1);
        eosWhitebalanceIconsMap.put(8, R.mipmap.whitebalance_shade);
        eosWhitebalanceIconsMap.put(9, R.mipmap.whitebalance_color_temperature);
        eosWhitebalanceIconsMap.put(10, R.mipmap.whitebalance_custom1);
        eosWhitebalanceIconsMap.put(11, R.mipmap.whitebalance_custom2);
        eosWhitebalanceIconsMap.put(12, R.mipmap.whitebalance_custom3);
        eosWhitebalanceIconsMap.put(15, R.mipmap.whitebalance_manual2);
        eosWhitebalanceIconsMap.put(16, R.mipmap.whitebalance_manual3);
        eosWhitebalanceIconsMap.put(18, R.mipmap.whitebalance_manual4);
        eosWhitebalanceIconsMap.put(19, R.mipmap.whitebalance_manual5);
        eosWhitebalanceIconsMap.put(20, R.mipmap.whitebalance_custom4);
        eosWhitebalanceIconsMap.put(21, R.mipmap.whitebalance_custom5);
        ...
        eosShootingModeIconsMap.put(0, R.mipmap.shootingmode_program);
        eosShootingModeIconsMap.put(1, R.mipmap.shootingmode_tv);
        eosShootingModeIconsMap.put(2, R.mipmap.shootingmode_av);
        eosShootingModeIconsMap.put(3, R.mipmap.shootingmode_m);
        eosShootingModeIconsMap.put(4, R.mipmap.shootingmode_bulb);
        eosShootingModeIconsMap.put(5, R.mipmap.shootingmode_adep);
        eosShootingModeIconsMap.put(6, R.mipmap.shootingmode_dep);
        eosShootingModeIconsMap.put(8, R.mipmap.shootingmode_lock);
        eosShootingModeIconsMap.put(9, R.mipmap.shootingmode_auto);
        eosShootingModeIconsMap.put(10, R.mipmap.shootingmode_night_scene_portrait);
        eosShootingModeIconsMap.put(11, R.mipmap.shootingmode_sports);
        eosShootingModeIconsMap.put(12, R.mipmap.shootingmode_portrait);
        eosShootingModeIconsMap.put(13, R.mipmap.shootingmode_landscape);
        eosShootingModeIconsMap.put(14, R.mipmap.shootingmode_close_up);
        eosShootingModeIconsMap.put(15, R.mipmap.shootingmode_flash_off);
        eosShootingModeIconsMap.put(19, R.mipmap.shootingmode_creativeauto);
        ...
        nikonWhitebalanceIconsMap.put(2, R.mipmap.whitebalance_auto);
        nikonWhitebalanceIconsMap.put(4, R.mipmap.whitebalance_daylight);
        nikonWhitebalanceIconsMap.put(5, R.mipmap.whitebalance_fluorescent);
        nikonWhitebalanceIconsMap.put(6, R.mipmap.whitebalance_tungsten);
        nikonWhitebalanceIconsMap.put(7, R.mipmap.whitebalance_flash);
        nikonWhitebalanceIconsMap.put(0x8010, R.mipmap.whitebalance_cloudy);
        nikonWhitebalanceIconsMap.put(0x8011, R.mipmap.whitebalance_shade);
        nikonWhitebalanceIconsMap.put(0x8012, R.mipmap.whitebalance_color_temperature);
        nikonWhitebalanceIconsMap.put(0x8013, R.mipmap.whitebalance_custom1); // TODO create Nikon specific icon
        ...
        nikonExposureProgramMap.put(0x0001, R.mipmap.shootingmode_m);
        nikonExposureProgramMap.put(0x0002, R.mipmap.shootingmode_program);
        nikonExposureProgramMap.put(0x0003, R.mipmap.shootingmode_av);
        nikonExposureProgramMap.put(0x0004, R.mipmap.shootingmode_tv);
        nikonExposureProgramMap.put(0x8010, R.mipmap.shootingmode_auto);
        nikonExposureProgramMap.put(0x8011, R.mipmap.shootingmode_portrait);
        nikonExposureProgramMap.put(0x8012, R.mipmap.shootingmode_landscape);
        nikonExposureProgramMap.put(0x8013, R.mipmap.shootingmode_close_up);
        nikonExposureProgramMap.put(0x8014, R.mipmap.shootingmode_sports);
        nikonExposureProgramMap.put(0x8015, R.mipmap.shootingmode_night_scene_portrait);
        nikonExposureProgramMap.put(0x8016, R.mipmap.shootingmode_flash_off);
        nikonExposureProgramMap.put(0x8017, R.mipmap.shootingmode_unknown); // TODO Child
        nikonExposureProgramMap.put(0x8018, R.mipmap.shootingmode_unknown); // TODO SCENE
        nikonExposureProgramMap.put(0x8050, R.mipmap.shootingmode_unknown); // TODO User mode U1
        nikonExposureProgramMap.put(0x8051, R.mipmap.shootingmode_unknown); // TODO User mode U2
        ...
        nikonMeteringModeMap.put(2, R.mipmap.metering_exposure_center_weighted_nikon);
        nikonMeteringModeMap.put(3, R.mipmap.metering_exposure_matrix_nikon);
        nikonMeteringModeMap.put(4, R.mipmap.metering_exposure_spot);

        eosMeteringModeIconsMap.put(1, R.mipmap.metering_exposure_spot);
        eosMeteringModeIconsMap.put(3, R.mipmap.metering_exposure_evaluative_canon);
        eosMeteringModeIconsMap.put(4, R.mipmap.metering_exposure_partial);
        eosMeteringModeIconsMap.put(5, R.mipmap.metering_exposure_center_weighted_average_canon);
        ...
        nikonFocusMeteringModeIconsMap.put(0x0002, R.mipmap.metering_af_dynamic_area);
        nikonFocusMeteringModeIconsMap.put(0x8010, R.mipmap.metering_af_single_point);
        nikonFocusMeteringModeIconsMap.put(0x8011, R.mipmap.metering_af_auto_area);
        nikonFocusMeteringModeIconsMap.put(0x8012, R.mipmap.metering_af_3d_tracking);

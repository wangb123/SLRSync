...
public interface Camera {
    ...
    public interface ImportToFileListener {
        void onImportToFile(int objectHandle, ObjectInfo objectInfo, File file);
    }
    ...
    void importImageToFile(int objectHandle, ImportToFileListener listener, @NonNull String destPath);
}
